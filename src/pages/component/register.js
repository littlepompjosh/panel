...
import HashPass from 'password-hash'
      ...
      handleSubmit = e => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
          if (!err) {
            ...
            var hashpassword = HashPass.generate(values.password);
      ...
      const websiteOptions = autoCompleteResult.map(website => (
        ...
        <div className="jeleen">
          ...
          {getFieldDecorator('residence', {
            rules: [
                { required: true, message: 'Please input residence!' },
                ],
                })(<Input type="text" />)}
            </Form.Item>
...
export default Form.create({ name: 'component' })(Register);